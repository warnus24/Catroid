...
public class SensorTests extends AndroidTestCase {
	...
	private MindstormConnection mindstormsConnection;

	@Override
	protected void setUp() throws Exception {
		super.setUp();

		this.connectionWrapper = new BluetoothConnectionWrapper(new MindstormsNXTHandler());
		connectionWrapper.startClientHandlerThread();

		this.mindstormsConnection = new MindstormConnectionImpl(connectionWrapper);
	...
	public void testGetSimpleSensorValue() {
		...
		sensor.getValue();
		byte[] command = null;
		byte[] firstCommand = connectionWrapper.getNextSentMessage(0, 2);
		while(firstCommand != null) {
			command = firstCommand;
			firstCommand = connectionWrapper.getNextSentMessage(0, 2);
		}
	...
	public void testGetSimpleSensorValueFullCommunication() {
		...
		command = connectionWrapper.getNextSentMessage(0, 2);
