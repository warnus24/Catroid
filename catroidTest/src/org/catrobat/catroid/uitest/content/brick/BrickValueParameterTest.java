...
public class BrickValueParameterTest extends BaseActivityInstrumentationTestCase<MainMenuActivity> {
	...
	public void testRobotAlbertBricksDefaultValues() {
		...
		TextView albertBuzzerTextView = (TextView) solo.getView(R.id.robot_albert_buzzer_action_frequency_text_view);
		...
		TextView albertEyeRedTextView = (TextView) solo.getView(R.id.robot_albert_rgb_led_action_red_text_view);
		...
		TextView albertEyeGreenTextView = (TextView) solo.getView(R.id.robot_albert_rgb_led_action_green_text_view);
		...
		TextView albertEyeBlueTextView = (TextView) solo.getView(R.id.robot_albert_rgb_led_action_blue_text_view);
		...
		TextView albertFrontLedTextView = (TextView) solo.getView(R.id.robot_albert_front_led_action_status_text_view);
