...
public class InsertItemIntoUserListTest extends BaseActivityInstrumentationTestCase<MainMenuActivity> {
	...
	public void testCreateNewUserVariableAndDeletion() {
		...
		UserList userList = (UserList) Reflection.getPrivateField(insertItemIntoUserListBrick, "userList");
		...
		userList = (UserList) Reflection.getPrivateField(insertItemIntoUserListBrick, "userList");
		assertNotNull("UserList is null", userList);
	...
	private void createProject() {
		...
		insertItemIntoUserListBrick = new InsertItemIntoUserListBrick(sprite, 10, 1);
