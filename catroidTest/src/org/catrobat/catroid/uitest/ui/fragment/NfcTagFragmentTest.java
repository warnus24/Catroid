...
public class NfcTagFragmentTest extends BaseActivityInstrumentationTestCase<MainMenuActivity> {
	...
	public void testBottomBarAndContextMenuOnActionModes() {
		...
		int timeToWait = 300;
		String addDialogTitle = solo.getString(R.string.new_nfctag_dialog_title);
	...
	public void testBottomBarElementsVisibilty() {
		...
		assertFalse("BottomBar separator is not visible",
    ...
    private String getTagId(int tagIndex) {
        tagDataList = projectManager.getCurrentSprite().getNfcTagList();
        return tagDataList.get(tagIndex).getNfcTagUid();
    }
