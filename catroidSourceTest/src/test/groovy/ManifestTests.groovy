...
public class ManifestTests {
    ...
    @Before void setUp() {
        manifestXML = new XmlParser().parse(new File("catroid/build/intermediates/manifests/standalone/AndroidManifest.xml"))
    ...
    public void testAppName() {
        def codeXML = new XmlParser().parse(new File("catroid/src/main/assets/standalone/code.xml"))
