...
public class TurnRightSpeedBrick extends FormulaBrick implements OnClickListener {
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, R.layout.brick_physic_turn_right_speed, null);
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, R.layout.brick_physic_turn_right_speed, null);
		TextView textXPosition = (TextView) prototypeView.findViewById(R.id.brick_turn_right_speed_prototype_text_view);
		textXPosition.setText(String.valueOf(BrickField.PHYSICS_TURN_RIGHT_SPEED));
