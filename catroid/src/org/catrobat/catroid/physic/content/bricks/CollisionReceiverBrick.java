...
public class CollisionReceiverBrick extends ScriptBrick implements BroadcastMessage {
	...
	public View getView(final Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, R.layout.brick_physic_collision_receive, null);
	...
	public View getPrototypeView(Context context) {
		View prototypeView = View.inflate(context, R.layout.brick_physic_collision_receive, null);
