...
public class SetVelocityBrick extends FormulaBrick implements OnClickListener {
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, R.layout.brick_physic_set_velocity, null);
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, R.layout.brick_physic_set_velocity, null);
		TextView textX = (TextView) prototypeView.findViewById(R.id.brick_set_velocity_prototype_text_view_x);
		textX.setText(String.valueOf(BrickField.PHYSICS_VELOCITY_X));
