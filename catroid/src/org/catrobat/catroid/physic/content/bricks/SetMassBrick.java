...
public class SetMassBrick extends FormulaBrick implements OnClickListener {
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, R.layout.brick_physic_set_mass, null);
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, R.layout.brick_physic_set_mass, null);
		TextView textXPosition = (TextView) prototypeView.findViewById(R.id.brick_set_mass_prototype_text_view);
		textXPosition.setText(String.valueOf(BrickField.PHYSICS_MASS));
