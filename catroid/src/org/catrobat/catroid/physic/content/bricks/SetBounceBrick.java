...
public class SetBounceBrick extends FormulaBrick implements OnClickListener {
	...
	public View getView(Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, R.layout.brick_physic_set_bounce_factor, null);
	...
	public View getPrototypeView(Context context) {
		prototypeView = View.inflate(context, R.layout.brick_physic_set_bounce_factor, null);
		TextView textView = (TextView) prototypeView.findViewById(R.id.brick_set_bounce_factor_prototype_text_view);
		textView.setText(String.valueOf(BrickValues.PHYSIC_BOUNCE_FACTOR));
