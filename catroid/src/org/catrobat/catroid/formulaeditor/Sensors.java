...
public enum Sensors {
	X_ACCELERATION, Y_ACCELERATION, Z_ACCELERATION, COMPASS_DIRECTION, X_INCLINATION, Y_INCLINATION, LOUDNESS, ARDUINODIGITAL, ARDUINOANALOG, FACE_DETECTED, FACE_SIZE, FACE_X_POSITION, FACE_Y_POSITION, OBJECT_X(
			true), OBJECT_Y(true), OBJECT_GHOSTEFFECT(true), OBJECT_BRIGHTNESS(true), OBJECT_SIZE(true), OBJECT_ROTATION(
			true), OBJECT_LAYER(true), NXT_SENSOR_1, NXT_SENSOR_2, NXT_SENSOR_3, NXT_SENSOR_4, KODEY_FRONT_LEFT, KODEY_FRONT_RIGHT,
			KODEY_SIDE_LEFT, KODEY_SIDE_RIGHT, KODEY_BOTTOM_LEFT, KODEY_BOTTOM_RIGHT;
