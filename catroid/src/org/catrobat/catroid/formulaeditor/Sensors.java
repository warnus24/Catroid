...
public enum Sensors {
	...
	DRONE_BATTERY_STATUS, EMERGENCY_STATE, FLYING, INITIALIZED, USB_ACTIVE, USB_REMAINING_TIME, CAMERA_READY,
	RECORD_READY,  OBJECT_X(true), OBJECT_Y(true), OBJECT_GHOSTEFFECT(true), OBJECT_BRIGHTNESS(true), OBJECT_SIZE(true),
