...
public enum Sensors {
	X_ACCELERATION, Y_ACCELERATION, Z_ACCELERATION, COMPASS_DIRECTION, X_INCLINATION, Y_INCLINATION, LOUDNESS, ALBERT_ROBOT_DISTANCE_LEFT, ALBERT_ROBOT_DISTANCE_RIGHT, OBJECT_X(
