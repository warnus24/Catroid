...
public class InternToExternGenerator {
	...
	static {
		...
		INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Functions.ARDUINODIGITAL.name(),
		...
		INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Sensors.KODEY_FRONT_LEFT.name(), R.string.kodey_sensor_front_left);
		INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Sensors.KODEY_FRONT_RIGHT.name(), R.string.kodey_sensor_front_right);
		INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Sensors.KODEY_SIDE_LEFT.name(), R.string.kodey_sensor_side_left);
		INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Sensors.KODEY_SIDE_RIGHT.name(), R.string.kodey_sensor_side_right);
		INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Sensors.KODEY_BOTTOM_LEFT.name(), R.string.kodey_sensor_bottom_left);
		INTERN_EXTERN_LANGUAGE_CONVERTER_MAP.put(Sensors.KODEY_BOTTOM_RIGHT.name(), R.string.kodey_sensor_bottom_right);
