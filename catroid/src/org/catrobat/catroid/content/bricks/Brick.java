...
public interface Brick extends Serializable, Cloneable {
	...
	enum BrickField {
		...
		ROBOT_ALBERT_SPEED, ROBOT_ALBERT_RGB_BLUE, ROBOT_ALBERT_RGB_GREEN, ROBOT_ALBERT_RGB_RED,
		ROBOT_ALBERT_FRONT_LED, ROBOT_ALBERT_DISTANCE_SENSOR_RIGHT, ROBOT_ALBERT_DISTANCE_SENSOR_LEFT,
		ROBOT_ALBERT_BUZZER, ROBOT_ALBERT_BODY_LED,
		
		DRONE_POWER_IN_PERCENT,	DRONE_TIME_TO_FLY_IN_SECONDS
	}
