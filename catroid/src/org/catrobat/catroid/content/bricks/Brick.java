...
public interface Brick extends Serializable, Cloneable {
	...
	enum BrickField {
		BRIGHTNESS, BRIGHTNESS_CHANGE, X_POSITION, Y_POSITION, X_POSITION_CHANGE, Y_POSITION_CHANGE, X_POSITION_VARIABLE,
		Y_POSITION_VARIABLE, TRANSPARENCY, TRANSPARENCY_CHANGE, SIZE, SIZE_CHANGE, VOLUME, VOLUME_CHANGE, X_DESTINATION, Y_DESTINATION, STEPS,
