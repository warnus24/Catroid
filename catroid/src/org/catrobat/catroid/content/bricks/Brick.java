...
public interface Brick extends Serializable, Cloneable {
	...
	enum BrickField {
		...
		DRONE_TIME_TO_FLY_IN_SECONDS, LIST_ADD_VALUE, LIST_DELETE_INDEX, INSERT_ITEM_INTO_USERLIST_VALUE, INSERT_ITEM_INTO_USERLIST_INDEX, REPLACE_ITEM_IN_USERLIST_VALUE, REPLACE_ITEM_IN_USERLIST_INDEX, DRONE_POWER_IN_PERCENT
	}
