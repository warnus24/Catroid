...
public interface Brick extends Serializable, Cloneable {
	...
	enum BrickField {
		...
		DRONE_TIME_TO_FLY_IN_SECONDS, ALBERT_ROBOT_DISTANCE_SENSOR_RIGHT, ALBERT_ROBOT_BUZZER, ALBERT_ROBOT_RGB_LED_EYE,
		ALBERT_ROBOT_BODY_LED, ALBERT_ROBOT_RGB_BLUE, ALBERT_ROBOT_RGB_GREEN, ALBERT_ROBOT_RGB_RED, DRONE_POWER_IN_PERCENT
	}
