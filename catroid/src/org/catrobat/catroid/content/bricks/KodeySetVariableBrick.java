...
public class KodeySetVariableBrick extends FormulaBrick implements OnClickListener, NewVariableDialogListener {
	...
	@Override
	public Brick clone() {
		SetVariableBrick clonedBrick = new SetVariableBrick(variableFormula.clone(), userVariable);
		return clonedBrick;
	}
	...
	public Brick copyBrickForSprite(Sprite cloneSprite) {
		...
		KodeySetVariableBrick copyBrick = (KodeySetVariableBrick) clone();
