...
public class VideoBrick extends BrickBaseType {
	...
	private String oldVideoSetting;
	private AdapterView<?> adapterView;
	private transient View prototypeView;
	private ArrayAdapter<CharSequence> videoSpinnerAdapter;
	...
	public View getPrototypeView(Context context) {
		...
		prototypeView = inflater.inflate(R.layout.brick_video, null);
		...
		if (selectedObject != null) {
			...
			videoSpinner.setSelection(videoSpinnerAdapter.getPosition(oldVideoSetting), true);
		}
	...
	public View getView(final Context context, int brickId, BaseAdapter baseAdapter) {
		...
		spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
			...
			public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
				...
				oldVideoSetting = selectedObject;
		...
		if (selectedObject != null) {
			...
			spinner.setSelection(videoSpinnerAdapter.getPosition(oldVideoSetting), true);
		}
