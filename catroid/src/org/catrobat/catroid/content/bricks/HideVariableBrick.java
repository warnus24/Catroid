...
public class HideVariableBrick extends BrickBaseType implements OnClickListener, NewVariableDialogListener {
	...
	public HideVariableBrick(UserVariable userVariable) {
	...
	public View getPrototypeView(Context context) {
		View prototypeView = View.inflate(context, R.layout.brick_hide_variable, null);
	...
	public View getViewWithAlpha(int alphaValue) {
		...
		if (view != null) {
			...
			TextView textHideVariable = (TextView) view.findViewById(R.id.brick_hide_variable_label);
			Spinner variablebrickSpinner = (Spinner) view.findViewById(R.id.hide_variable_spinner);

			ColorStateList color = textHideVariable.getTextColors().withAlpha(alphaValue);
			variablebrickSpinner.getBackground().setAlpha(alphaValue);
			if (adapterView != null) {
				((TextView) adapterView.getChildAt(0)).setTextColor(color);
			}
			textHideVariable.setTextColor(textHideVariable.getTextColors().withAlpha(alphaValue));
	...
	@Override
	public Brick clone() {
		HideVariableBrick clonedBrick = new HideVariableBrick(userVariable);
		return clonedBrick;
	}
	...
	public List<SequenceAction> addActionToSequence(Sprite sprite, SequenceAction sequence) {
		sequence.addAction(ExtendedActions.hideVariable(sprite, userVariable));
		return null;
	}

	@Override
	public Brick copyBrickForSprite(Sprite sprite) {
		HideVariableBrick copyBrick = (HideVariableBrick) clone();
