...
public class DroneMoveLeftBrick extends DroneMoveBrick {
	...
	@Override
	public Brick clone() {
		return new DroneMoveLeftBrick(getSprite(), timeToFlyInSeconds.clone(), powerInPercent.clone());
	}

	@Override
	public List<SequenceAction> addActionToSequence(SequenceAction sequence) {
		sequence.addAction(ExtendedActions.droneMoveLeft(sprite, timeToFlyInSeconds, powerInPercent));
		return null;
	}
}
