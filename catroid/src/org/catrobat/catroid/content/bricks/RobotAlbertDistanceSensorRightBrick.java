...
public class RobotAlbertDistanceSensorRightBrick extends FormulaBrick implements OnClickListener, NewDataDialog.NewUserListDialogListener {
	...
	public View getView(final Context context, int brickId, BaseAdapter baseAdapter) {
		...
		view = View.inflate(context, R.layout.brick_robot_albert_distance_sensor_right, null);
		view = getViewWithAlpha(alphaValue);
		setCheckboxView(R.id.brick_robot_albert_distance_sensor_right_checkbox);
...
//		});
	...
	public View getPrototypeView(Context context) {
		View prototypeView = View.inflate(context, R.layout.brick_robot_albert_distance_sensor_right, null);
	...
	public View getViewWithAlpha(int alphaValue) {
		LinearLayout layout = (LinearLayout) view.findViewById(R.id.brick_robot_albert_distance_sensor_right_layout);
	...
	public void onClick(View view) {
		...
		FormulaEditorFragment.showFragment(view, this, BrickField.ROBOT_ALBERT_DISTANCE_SENSOR_RIGHT);
	}
