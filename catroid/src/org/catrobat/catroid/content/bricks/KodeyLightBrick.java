...
public class KodeyLightBrick extends BrickBaseType implements OnItemSelectedListener {
    ...
    */
	...
	public Brick copyBrickForSprite(Sprite sprite) {
		KodeyLightBrick copyBrick = (KodeyLightBrick) clone();
