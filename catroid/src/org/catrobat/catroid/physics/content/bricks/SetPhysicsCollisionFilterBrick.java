...
public class SetPhysicsCollisionFilterBrick extends BrickBaseType implements Cloneable{
	...
	public SetPhysicsCollisionFilterBrick() {
	}

	public SetPhysicsCollisionFilterBrick(Sprite sprite, PhysicsObject.Behavior behavior) {
		this.sprite = sprite;
	...
	@Override
	public Brick clone() {
		return new SetPhysicsCollisionFilterBrick(sprite, behavior);
	}
	...
	public Brick copyBrickForSprite(Sprite sprite, Script script) {
		SetPhysicsCollisionFilterBrick copyBrick = (SetPhysicsCollisionFilterBrick) clone();
