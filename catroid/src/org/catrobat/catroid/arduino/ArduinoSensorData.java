...
public final class ArduinoSensorData {
	...
	public void setArduinoDigitalSensor(int arduinoDigitalSensor) {
		this.arduinoDigitalSensor = arduinoDigitalSensor;
	}
	...
	public void setArduinoAnalogSensor(int arduinoAnalogSensor) {
		this.arduinoAnalogSensor = arduinoAnalogSensor;
	}
}
