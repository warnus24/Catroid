...
public enum ArduinoCommandByte {
	PLAY_TONE(0x03),
	...
	private static final SparseArray<ArduinoCommandByte> LOOKUP = new SparseArray<ArduinoCommandByte>();

	static {
		for (ArduinoCommandByte c : ArduinoCommandByte.values()) {
			LOOKUP.put(c.commandByteValue, c);
		}
	}

	private ArduinoCommandByte(int commandByteValue) {
	...
	public static ArduinoCommandByte getTypeByValue(byte value) {
