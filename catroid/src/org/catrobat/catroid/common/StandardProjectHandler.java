...
public final class StandardProjectHandler {
	...
	public static Project createAndSaveStandardPhysicsProject(String projectName, Context context) throws IOException {
		...
		PhysicsWorld physicsWorld = defaultProject.getPhysicsWorld();
		...
		setPhysicsProperties(ball, ballStartScript, PhysicsObject.Type.DYNAMIC, 20.0f, 80.0f);
		...
		ballBroadcastScript.addBrick(new PlaceAtBrick( -200, 300));
		...
		startScript2.addBrick(new SetGravityBrick( new Vector2(0.0f, -8.0f)));
		...
		setPhysicsProperties(ball2, ballStartScript2, PhysicsObject.Type.DYNAMIC, 20.0f, 80.0f);

		// Ball v2
		String ballBroadcastMessage2 = "restart ball2";
		BroadcastBrick ballBroadcastBrick2 = new BroadcastBrick( ballBroadcastMessage2);
		ballStartScript2.addBrick(ballBroadcastBrick2);
		ball2.addScript(ballStartScript2);

		BroadcastScript ballBroadcastScript2 = new BroadcastScript( ballBroadcastMessage2);
	...
	private static void createMovingArm(Sprite sprite, String broadcastMessage, float degreeSpeed) {
		...
		broadcastScript.addBrick(new PointInDirectionBrick( Direction.UP));
