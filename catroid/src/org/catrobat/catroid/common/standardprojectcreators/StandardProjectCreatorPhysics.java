...
public class StandardProjectCreatorPhysics extends StandardProjectCreator {
	...
	public Project createStandardProject(String projectName, Context context) throws IOException,
		...
		backgroundImageScaleVector = ImageEditing.calculateXYScaleFactorToScreenSize(
		...
		Sprite restart = new Sprite("Restart View");
		...
		Script physicsCollisionScript = new CollisionScript("Restart View<->Ball");
	...
	private Script createElement(Context context, String projectName, Sprite sprite, String fileName, int fileId, Vector2 position, float angle, float scale)
			throws IOException {
