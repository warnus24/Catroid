...
public class KodeyMotorBackwardSingleSeekbarFragment extends SherlockFragment implements OnKeyListener {
	...
	private void setUpActionBar() {
		...
		actionBar.setTitle(R.string.kodey_motor_backward_title);
	}
	...
	public static void showSingleSeekBarFragment(View view, Brick brick, Formula speed)
	{
		...
		KodeyMotorBackwardSingleSeekbarFragment formulaEditorSingleSeekbarFragment = (KodeyMotorBackwardSingleSeekbarFragment) activity.getSupportFragmentManager()
				.findFragmentByTag(FORMULA_EDITOR_MOTOR_BACKWARD_SINGLE_SEEKBAR_FRAGMENT_TAG);

		FragmentManager fragmentManager = activity.getSupportFragmentManager();
		FragmentTransaction fragTransaction = fragmentManager.beginTransaction();

		if (formulaEditorSingleSeekbarFragment == null) {
			formulaEditorSingleSeekbarFragment = new KodeyMotorBackwardSingleSeekbarFragment();
			...
			fragTransaction.add(R.id.script_fragment_container, formulaEditorSingleSeekbarFragment, FORMULA_EDITOR_MOTOR_BACKWARD_SINGLE_SEEKBAR_FRAGMENT_TAG);
		}
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
		...
		motorActionBrickSpeedTextView = (TextView) fragmentView.findViewById(R.id.brick_kodey_motor_backward_action_speed_edit_text);
			...
			public void onProgressChanged(SeekBar seekBar, int i, boolean b) {
				switch(seekBar.getId())
				{
					case R.id.kodey_motor_speed_seekbar:
						...
						((KodeyMotorBackwardActionBrick)currentBrick).setSpeedTextValue(seekBar.getProgress());
						break;
					default:
						break;
				}
	...
	public void onPrepareOptionsMenu(Menu menu) {
		...
		getSherlockActivity().getSupportActionBar().setTitle(getString(R.string.kodey_motor_backward_title));
