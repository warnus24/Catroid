...
import org.catrobat.catroid.physics.content.bricks.SetPhysicsCollisionFilterBrick;
...
public class CategoryBricksFactory {
	...
	private List<Brick> setupControlCategoryList(Sprite sprite, Context context) {
		...
		controlBrickList.add(new CollisionReceiverBrick(sprite, "object"));
	...
	private List<Brick> setupMotionCategoryList(Sprite sprite) {
		...
		// TODO[physics]
		motionBrickList.add(new SetPhysicsCollisionFilterBrick(sprite, BrickValues.PHYSIC_BEHAVIOR));
