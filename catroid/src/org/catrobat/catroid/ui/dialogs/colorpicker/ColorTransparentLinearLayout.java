...
public class ColorTransparentLinearLayout extends LinearLayout {

	private Paint mColorPaint = new Paint();

	public ColorTransparentLinearLayout(Context context) {
		super(context);
	}

	public ColorTransparentLinearLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
	}
