...
package org.catrobat.catroid.ui.dialogs.colorpicker;

import java.util.ArrayList;

import org.catrobat.catroid.R;
import org.catrobat.catroid.ui.dialogs.BaseDialog;
...
public final class ColorPickerDialog extends BaseDialog {
	...
	private ColorTransparentLinearLayout mBaseButtonLayout;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Bitmap backgroundBitmap = BitmapFactory.decodeResource(getContext()
				.getResources(), R.drawable.brick_selection_background_kodey); //ToDO: check if this is correct
		BitmapShader mBackgroundShader = new BitmapShader(backgroundBitmap,
				TileMode.REPEAT, TileMode.REPEAT);

		mBackgroundPaint.setShader(mBackgroundShader);

		mBaseButtonLayout = (ColorTransparentLinearLayout) findViewById(R.id.colorchooser_ok_button_base_layout);
