...
public class SelectPostProcessingEffectFragment extends SherlockListFragment implements OnProjectEditListener {
	...
	private class LoadProject extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... params) {
			...
			if (!preview_loadable) {
				getFragmentManager().beginTransaction().remove(selectPostProcessingEffectFragment).commit();
				getFragmentManager().popBackStack();
